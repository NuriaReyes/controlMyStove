    ...
    while (client.connected()) {                       //Si el cliente esta conectado...
      if (client.available()) {                        //Y hay datos para recibir...
        ...
        if (c == '\n' && currentLineIsBlank) {
            ...
            client.println("<input type='radio' name='on_off' id='on' value='on' checked=''>");
            client.println("Prender estufa");
            client.println("<input type='radio' name='on_off' id='off' value='off' >");
            ...
            client.println("<input type='text' class='form-control' id='time' placeholder='minutos...'>");
            client.println("<button type='submit'>Ejecutar</button>");
            client.println("</form>");
            ...
            client.println("  <option value='40'>60</option>");
            client.println("  <option value='40'>80</option>");
            client.println("  <option value='40'>100</option>");
            client.println("</select>");
