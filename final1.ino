...
void loop() {
  ...
  if (stoveonstate == HIGH && timeron == 0) {
    ...
    if (timer != 0){                                                  // En caso de que el usiario ingrese un timer 
      delay (timer);
      digitalWrite(gas, LOW);
      timeron ++;    }
        if(nivelestufa<=3){                                           //Nivel de flama muy bajo
     digitalWrite(8, LOW);
     digitalWrite(9, LOW);
     digitalWrite(10, LOW);}
  else if(nivelestufa>=10 && nivelestufa<=100){                       //Nivel de flama bajo
     digitalWrite(8, HIGH); 
     digitalWrite(9, LOW);
     digitalWrite(10, LOW);}
  else if(nivelestufa>=200 && nivelestufa<=299){                      //Nivel de flama medio
     digitalWrite(9, HIGH); 
     digitalWrite(10, LOW); }
  else if (nivelestufa>=300){                                         //Nivel de flama alto
     digitalWrite(10, HIGH);} 
  }


  if(temphorno>=200){                                                //Temperatura del horno
     digitalWrite(11, HIGH);}
  else if (temphorno<=199){
     digitalWrite(11, LOW);}

  if(gass>=200){                                                    //Sensor de gas
  ...
  delay(1);                                                         // delay in between reads for stability
   ...
   if (stoveonstate == LOW) {                                       //Encendio apagado
    digitalWrite(gas, LOW);
    digitalWrite(chispa, LOW);
    digitalWrite(8, LOW);
    digitalWrite(9, LOW);
